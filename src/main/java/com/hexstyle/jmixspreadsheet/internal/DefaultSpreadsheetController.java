...
import com.hexstyle.jmixspreadsheet.diff.*;
...
import com.hexstyle.jmixspreadsheet.diff.LayoutValidator;
import com.hexstyle.jmixspreadsheet.edit.FlatTableCellEditor;
import com.hexstyle.jmixspreadsheet.edit.PivotTableCellEditor;
...
import com.hexstyle.jmixspreadsheet.render.SpreadsheetRenderer;
...
public class DefaultSpreadsheetController<E, DC> implements SpreadsheetController<E, DC> {
    ...
    private void rebuildLayoutIndex() {
        ...
        java.util.function.Function<E, Object> entityKeyProvider = io.jmix.core.entity.EntityValues::getId;
        this.layoutIndex = new DefaultLayoutIndex<>(
    ...
    public void updateAffectedCells(java.util.Set<Object> affectedEntityKeys) {
        ...
        java.util.function.Function<E, Object> entityKeyProvider = io.jmix.core.entity.EntityValues::getId;
        LayoutIndex<E> newLayoutIndex = new DefaultLayoutIndex<>(
                currentLayout, entityKeyProvider);
        ...
        if (!allCellsToUpdate.isEmpty()) {
            LayoutDelta combinedDelta = new DefaultLayoutDelta(allCellsToUpdate);
    ...
    private java.util.Set<LayoutIndex.CellRef> findChangedCellsByValueComparison() {
        ...
        for (CellBinding<E> newBinding : currentLayout.getCellBindings()) {
            ...
            if (newBinding.getPivotContext() != null) {
                ...
                if (newBinding instanceof PivotCellBinding) {
                    PivotCellBinding<E> pivotBinding =
                            (PivotCellBinding<E>) newBinding;
    ...
    private void applyDirectCellUpdates(LayoutDelta delta) {
        ...
        DefaultSpreadsheetRenderer<E, Spreadsheet> defaultRenderer =
                (DefaultSpreadsheetRenderer<E, Spreadsheet>) renderer;
     ...
     */
    @SuppressWarnings("unchecked")
    private DefaultSpreadsheetRenderer.CellRenderer<Spreadsheet> getCellRenderer(
            DefaultSpreadsheetRenderer<E, Spreadsheet> renderer) {
        try {
            java.lang.reflect.Field field = DefaultSpreadsheetRenderer.class
                    .getDeclaredField("cellRenderer");
            field.setAccessible(true);
            return (DefaultSpreadsheetRenderer.CellRenderer<Spreadsheet>) field.get(renderer);
        } catch (Exception e) {
    ...
    private void setupInteractionListeners() {
        ...
        SpreadsheetInteractionHandler<E> handler = model.getInteractionHandler();
        if (handler == null) {
            return;
        }
        if (component instanceof com.vaadin.flow.component.spreadsheet.Spreadsheet) {
            com.vaadin.flow.component.spreadsheet.Spreadsheet vaadinSpreadsheet =
                    (com.vaadin.flow.component.spreadsheet.Spreadsheet) component;
            vaadinSpreadsheet.addSelectionChangeListener(event ->
                    SpreadsheetInteractionBridge.handleSelectionChange(event, handler, layoutIndex));
        }
    }
