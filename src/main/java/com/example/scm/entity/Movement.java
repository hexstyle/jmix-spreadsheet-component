...
@JmixEntity
@Table(name = "SCM_MOVEMENT", indexes = {
        @Index(name = "IDX_SCM_MOVEMENT_WAREHOUSE", columnList = "WAREHOUSE_ID"),
        @Index(name = "IDX_SCM_MOVEMENT_PRODUCT", columnList = "PRODUCT_ID"),
        @Index(name = "IDX_SCM_MOVEMENT_PRODUCT_PACKAGE", columnList = "PRODUCT_PACKAGE_ID"),
        @Index(name = "IDX_SCM_MOVEMENT_ORIGIN_PLANT", columnList = "ORIGIN_PLANT_ID"),
        @Index(name = "IDX_SCM_MOVEMENT_REASON", columnList = "REASON_ID"),
        @Index(name = "IDX_SCM_MOVEMENT_TRACK", columnList = "TRACK_ID")
})
@Entity(name = "scm_Movement")
