...
@JmixEntity
@Table(name = "SCM_PRODUCT", indexes = {
        @Index(name = "IDX_SCM_PRODUCT_UNQ", columnList = "NAME", unique = true),
        @Index(name = "IDX_SCM_PRODUCT_PRODUCT_NORMAL", columnList = "PRODUCT_NORMAL_ID")
})
@Entity(name = "scm_Product")
