...
@JmixEntity
@Table(name = "SCM_TRANSPORT_TYPE", indexes = {
        @Index(name = "IDX_SCM_TRANSPORT_TYPE_UNQ", columnList = "NAME", unique = true),
        @Index(name = "IDX_SCM_TRANSPORT_TYPE_TRANSPORT_CATEGORY", columnList = "TRANSPORT_CATEGORY_ID")
})
@Entity(name = "scm_TransportType")
public class TransportType implements Archivable {
    @JmixGeneratedValue
