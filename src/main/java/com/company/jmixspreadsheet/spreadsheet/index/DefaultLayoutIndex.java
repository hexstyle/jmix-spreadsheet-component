    ...
    private void buildIndex(SpreadsheetLayout<E> layout, java.util.function.Function<E, Object> entityKeyProvider) {
        for (CellBinding<E> binding : layout.getCellBindings()) {
            ...
            if (binding.getPivotContext() != null) {
                ...
                if (binding instanceof com.company.jmixspreadsheet.spreadsheet.layout.PivotCellBinding) {
                    com.company.jmixspreadsheet.spreadsheet.layout.PivotCellBinding<E> pivotBinding =
                            (com.company.jmixspreadsheet.spreadsheet.layout.PivotCellBinding<E>) binding;
