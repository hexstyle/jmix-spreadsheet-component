...
class PortBalanceAggregatorTest {
    ...
    void aggregatesPortBalanceTable() {
        ...
        List<String> detailRowIds = table.getRows().stream()
                ...
                .map(com.digtp.scm.portbalance.rows.PortBalanceRow::getRowId)
                .toList();
    ...
    private PreParty createPreParty(Plant plant,
        ...
        preParty.setSalesChannel(com.digtp.scm.entity.SalesChannel.RSO);
        preParty.setTransactionStatus(com.digtp.scm.entity.TransactionStatus.UNSOLD);
