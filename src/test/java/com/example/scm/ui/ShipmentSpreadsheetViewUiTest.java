...
import com.example.scm.portbalance.data.TestDataFactory.January2026PortBalanceData;
...
class ShipmentSpreadsheetViewUiTest {
    ...
    void viewRendersJanuaryPortBalanceDataAndResolvesMessages() {
        ...
        try {
            ...
            String resolvedTitle = messages.getMessage("com.example.scm.view.shipment/ShipmentSpreadsheetView.title");
            ...
            if (baseLink != null) {
                Assertions.assertThat(baseLink.getText())
                        .isEqualTo(messages.getMessage("com.example.scm.view.main/applicationTitle.text"));
            ...
            PropertyFilter<com.example.scm.entity.Track> trackFilter = castFilter(
                    findPropertyFilter(filter, "track", PropertyFilter.Operation.EQUAL));
            PropertyFilter<com.example.scm.entity.Terminal> terminalFilter = castFilter(
            ...
            Assertions.assertThat(
                    spreadsheetContains(spreadsheet, String.valueOf(data.negativeStockValue()))
                            || findFirstNegativeStockStyledCell(spreadsheet) != null
            ).isTrue();
            ...
            if (negativeStockCell == null) {
                negativeStockCell = findFirstNegativeStockStyledCell(spreadsheet);
            }
    ...
    void cellDetailsViewLoadsTerminalCode() {
        ...
        try {
            View<?> view = dialog.getView();
            DataGrid<com.example.scm.entity.VesselLoad> grid = UiTestUtils.getComponent(
                    view, "vesselLoadGrid");
    ...
    void cellDetailsViewShowsOnlyInMovements() {
        ...
        try {
            DataGrid<com.example.scm.entity.PlantShipmentReason> plantGrid =
                    UiTestUtils.getComponent(dialog.getView(), "plantShipmentGrid");
            DataGrid<com.example.scm.entity.VesselLoadItem> outGrid =
                    UiTestUtils.getComponent(dialog.getView(), "vesselLoadItemGrid");
            DataGrid<com.example.scm.entity.VesselLoad> vesselGrid =
    ...
    void cellDetailsViewUsesVesselLoadSelectionForItems() {
        ...
        try {
            DataGrid<com.example.scm.entity.VesselLoad> vesselGrid =
                    UiTestUtils.getComponent(dialog.getView(), "vesselLoadGrid");
            DataGrid<com.example.scm.entity.VesselLoadItem> itemGrid =
                    UiTestUtils.getComponent(dialog.getView(), "vesselLoadItemGrid");

            List<com.example.scm.entity.VesselLoad> loads = vesselGrid.getItems().getItems().stream().toList();
            Assertions.assertThat(loads).hasSizeGreaterThanOrEqualTo(2);

            com.example.scm.entity.VesselLoad first = loads.get(0);
            ...
            com.example.scm.entity.VesselLoad second = loads.get(1);
    ...
    private Cell findFirstNegativeStockStyledCell(Spreadsheet spreadsheet) {
        if (spreadsheet == null || spreadsheet.getWorkbook() == null) {
            return null;
        }
        Sheet sheet = spreadsheet.getWorkbook().getSheetAt(0);
